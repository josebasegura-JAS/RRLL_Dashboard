...
contextBridge.exposeInMainWorld("rrllDB", {
  ...
  loadBudgetActuals: year => ipcRenderer.invoke("db:loadBudgetActuals", year),
  saveBudgetActual: payload => ipcRenderer.invoke("db:saveBudgetActual", payload),
  deleteBudgetActual: id => ipcRenderer.invoke("db:deleteBudgetActual", id),
